...
-- suites
INSERT INTO suites (title, description, primePicture, link, price_id, hotel_id) VALUES ('Maija Isola', 'Une magnifique suite à la décoration florale, propice à la détente. Lorem ispum dolor sit amet. Aut deleniti velit et culpa facere qui voluptas veritatis ut consequatur voluptas et reiciendis dolores qui mollitia blanditiis.', 'https://hypnoshotelgroup.s3.eu-west-3.amazonaws.com/hypnos-hotel1-suite-1.jpg', 'https://www.google.com/', 1, 1);
INSERT INTO suites (title, description, primePicture, link, price_id, hotel_id) VALUES ('Maija Louekari', 'Profitez, dans cette suite ornée du motif Siirtolapuutarha, d''un univers de jardin onirique et coloré. Lorem ispum dolor sit amet. Aut deleniti velit et culpa facere qui voluptas veritatis ut consequatur voluptas et reiciendis dolores qui mollitia blanditiis.', 'https://hypnoshotelgroup.s3.eu-west-3.amazonaws.com/hypnos-hotel1-suite-2.jpg', 'https://www.google.com/', 1, 1);
INSERT INTO suites (title, description, primePicture, link, price_id, hotel_id) VALUES ('Armi Ratia ', 'L''univers de la suite Armi Ratia conviendra aux adeptes de la simplicité. Lorem ispum dolor sit amet. Aut deleniti velit et culpa facere qui voluptas veritatis ut consequatur voluptas et reiciendis dolores qui mollitia blanditiis.', 'https://hypnoshotelgroup.s3.eu-west-3.amazonaws.com/hypnos-hotel1-suite-3.jpg', 'https://www.google.com/', 1, 1);
INSERT INTO suites (title, description, primePicture, link, price_id, hotel_id) VALUES ('Sanna Annuka', 'Cette suite nous plonge dans une tradition finlandaise très colorée. Lorem ispum dolor sit amet. Aut deleniti velit et culpa facere qui voluptas veritatis ut consequatur voluptas et reiciendis dolores qui mollitia blanditiis.', 'https://hypnoshotelgroup.s3.eu-west-3.amazonaws.com/hypnos-hotel1-suite-4.jpg', 'https://www.google.com/', 1, 1);
...
INSERT INTO suites (title, description, primePicture, link, price_id, hotel_id) VALUES ('Bouroullec', 'Sobre et coquette, la suite Bouroullec rappelle les chalets nordiques et se démarque par sa gamme de textures et de couleurs. Le bois brut des meubles contraste avec les teintes irisées, aux airs d’aurore boréale, des lattes de céramique qui enveloppent sa douche multi-jets et sa baignoire sabot.', 'https://hypnoshotelgroup.s3.eu-west-3.amazonaws.com/hypnos-hotel2-suite-3.jpg', 'https://www.google.com/', 1, 2);
INSERT INTO suites (title, description, primePicture, link, price_id, hotel_id) VALUES ('Fintone', 'Le spectaculaire décor de la suite Finetone joue sur le contraste entre le doré lumineux de ses murs et le noir profond de sa paroi en bois laqué. Amateurs de lieux au luxe chatoyant, venez vous prélasser dans sa magnifique baignoire qui est une pièce à part entière!', 'https://hypnoshotelgroup.s3.eu-west-3.amazonaws.com/hypnos-hotel2-suite-4.jpg', 'https://www.google.com/', 1, 2);
INSERT INTO suites (title, description, primePicture, link, price_id, hotel_id) VALUES ('Rybakken', 'Avec ses tons bleutés, la suite Rybakken saura vous transporter au firmament. Son décor aérien et lumineux en fait le lieu idéal pour se détendre, en paressant dans sa baignoire douillette ou sur son lit à baldaquin moderne, tous deux surplombés d''un plafond de miroirs.', 'https://hypnoshotelgroup.s3.eu-west-3.amazonaws.com/hypnos-hotel2-suite-5.jpg', 'https://www.google.com/', 1, 2);
INSERT INTO suites (title, description, primePicture, link, price_id, hotel_id) VALUES ('Poul Henningsen', 'Suite de luxe avec accès privé, la suite Poul Henningsen est aménagée sur deux étages, dans un décor éclatant qui ose le rose et le doré ! Avec sa chambre mezzanine surplombant le salon, la Nordique est particulièrement spacieuse. Son ambiance séduisante est mise en valeur par de nombreux éclairages et un jeu de miroirs.', 'https://hypnoshotelgroup.s3.eu-west-3.amazonaws.com/hypnos-hotel3-suite-1.jpg', 'https://www.google.com/', 1, 3);
INSERT INTO suites (title, description, primePicture, link, price_id, hotel_id) VALUES ('Arne Jacobsen', 'Multipliant les touches qui évoquent la nature, la Arne Jacobsen est une suite d’esprit nordique. Avec ses panneaux imitation bois et son large banc, sa salle de bain n''est pas sans rappeler l''espace du sauna, tout en étant équipée d’une luxueuse douche pluie. Petits plus : un balcon privé et un lit king.', 'https://hypnoshotelgroup.s3.eu-west-3.amazonaws.com/hypnos-hotel3-suite-2.jpg', 'https://www.google.com/', 1, 3);
INSERT INTO suites (title, description, primePicture, link, price_id, hotel_id) VALUES ('Anu Moser', 'La suite Siberia a l''intimité et le cachet d''une cabane dans la forêt, le confort en plus ! Cette suite tire tout son charme de son mobilier en bois rustique, son foyer et ses couleurs chaleureuses. Une jolie particularité : le miroir mural au-dessus de la grande baignoire îlot.', 'https://hypnoshotelgroup.s3.eu-west-3.amazonaws.com/hypnos-hotel3-suite-3.jpg', 'https://www.google.com/', 1, 3);

...
let modifySuiteBtn = document.getElementById('modifySuiteBtn')

modifySuiteBtn.addEventListener('click', (e)=>{
    ...
    if(primePicture.files.length === 1){
        if(checkPicture(primePicture.files[0]) === false){

...
<section class="row  px-lg-5">
    ...
    <div class="col-12 col-md-6">
        <h2 class="text-tilered mb-3">Mes réservations</h2>
    ...
    <?php
        ...
        $bookingsReq = $bdd->prepare('SELECT bookings.id AS id, 
                                    ...
                                    DATE_FORMAT(bookings.cancellationDate, "%d/%m/%Y" ) AS cancellationDate, 
                                    suites.title, 
                                    hotels.name
                                    FROM bookings 
                ...
                <div class="card h-100">
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        if($today < $booking['cancellationDate']){ ?>
                            <div class="text-end">
                                <a type="button" href="#" class="btn bg-offwhite border-gold rounded-pill text-gold px-5">Annuler</a>
                            </div>
                        <?php }
                        ?>
                    </div>
